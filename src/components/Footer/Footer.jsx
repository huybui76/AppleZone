  ...
  return (
    <div className='footer_container'>
        ...
        <p className="footer_notice">
                ...
                have additional requirements. Apple or its trade-in partners reserve the right to refuse or limit quantity 
                of any trade-in transaction for any reason. More details are available from Apple’s trade-in partner for 
                ...
                <br />
                <br />
                Apple Vision Pro will be available early next year on <a href="https://www.apple.com/" className="support-apple-link">apple.com</a> and at Apple retail stores in the U.S.
                <br />
                <br />
                To access and use all Apple Card features and products available only to Apple Card users, you must add Apple Card to Wallet 
                on an iPhone or iPad that supports and has the latest version of iOS or iPadOS. Apple Card is subject to credit approval, 
                available only for qualifying applicants in the United States, and issued by Goldman Sachs Bank USA, Salt Lake City Branch.
                <br />
                <br />
                ...
                at <a href="https://support.apple.com/vi-vn/102585" className="support-apple-link">support.apple.com/kb/HT209218</a>.
                <br />
                <br />
            ...
            <div className="container_1">
                ...
                <div className="footer-column">
                    ...
                    <div className="footer_content">
                        ...
                        <div className='quick-links' id=''>TV & Home</div>                        
                        <div className='quick-links' id=''>AirTag</div>                        
                        <div className='quick-links' id=''>Accessories</div>                        
                        <div className='quick-links' id=''>Gift Cards</div>                        
                    </div>
                    ...
                    <div className="footer_content">
                        ...
                        <div className='quick-links' id=''>Apple Pay</div>                        
                        <div className='quick-links' id=''>Apple Cash</div>                                         
                    </div>
                ...
                <div className=''>
                    ...
                    <div className="footer_content">
                        ...
                        <div className='quick-links' id=''>Apple Music</div>                       
                        <div className='quick-links' id=''>Apple Arcade</div>                       
                        <div className='quick-links' id=''>Apple Fitness+</div>                       
                        <div className='quick-links' id=''>Apple News+</div>                       
                ...
                <div className="footer-column">
                    ...
                    <div className="footer_content">
                        ...
                        <div className='quick-links' id=''>Today at Apple</div>
                        <div className='quick-links' id=''>Apple Camp</div>
                        <div className='quick-links' id=''>Apple Store App</div>
                        <div className='quick-links' id=''>Certified Refurbished</div>
                        <div className='quick-links' id=''>Apple Trade In</div>
                ...
                <div className="footer-column">
                    ...
                    <div className="footer_content">
                        <div className='quick-links' id=''>Shop for Government</div>                                           
                        <div className='quick-links' id=''>Shop for Veterans and Military</div>                                                                                 
                    </div>
